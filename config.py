...
BOT_TOKEN = getenv("BOT_TOKEN", "7620786154:AAGiklSgpU8bIQDcj0rPDMnSmTTERrld4Ig")
...
LOG_GROUP = getenv("LOG_GROUP", "1002262834526")
CHANNEL_ID = int(getenv("CHANNEL_ID", "1002272386888"))
